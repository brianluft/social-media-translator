...
cp AppIcon.png "../Translator/Translator/Assets.xcassets/AppIcon.appiconset/AppIcon_1024.png"
...
BACKGROUND_DST="../Translator/Translator/Assets.xcassets/Background.imageset/Background.jpg"
